...
spec_dir = os.path.abspath("..") + "/Instance-Segmentation"
...
COCO_WEIGHTS_PATH = os.path.join(spec_dir, "mask_rcnn_coco.h5")
...
class BasketballConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Basketball has 3 object classes: players, basketball, referees
...
class BasketballDataset(utils.Dataset):
    def load_basketball(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "player_only.json")))
        annotations = list(annotations.values())  # don't need the dict keys
        
        # single image
        #spec_dir = os.path.abspath(".")
        #annotat2 = json.load(open(os.path.join(spec_dir,"via_export_json (1).json")))
        ...
        for a in annotations:
            ...
            self.add_image(
                ...
                polygons=polygons)
        #add basketball image
        #self.add_image("basketball_player", image_id = 'frame15600.jpg', path = "/Users/niyaz/Desktop/Instance-Segmentation/datasets/balloon/train/frame15600.jpg", height = 720, width = 1280, polygons = [dict(annotat2['frame15600.jpg293844']['regions'][0]['shape_attributes'])])
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "basketball_player":
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect basketball.')
